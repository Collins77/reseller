...
import { GET_ALL_CATEGORIES_ROUTE, GET_ALL_PRODUCTS, GET_ALL_SUPPLIER_ROUTES } from "@/lib/constants"
...
const BrandResults = () => {
    ...
    const filteredProducts = products.filter(product => product.brand.toLowerCase() === slug.toLowerCase());
            ...
            <div className="mt-5 mb-7 px-[20px]">
                <Breadcrumb>
                    <BreadcrumbList>
                        ...
                        <BreadcrumbSeparator />
                        <BreadcrumbItem>
                            <BreadcrumbPage href="/suppliers">Brands</BreadcrumbPage>
                        </BreadcrumbItem>
                    </BreadcrumbList>
                </Breadcrumb>
            </div>
